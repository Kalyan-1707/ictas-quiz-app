    ...
    <div class="container">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <label for="q1"><pre>There is a town called Metron, where wheels of the front and rear of vehicles are of different size.
The measurement unit followed in the town is the metre. 
The circumference of the front wheel of the car is 133 metres and that of rear wheels is 190 metres.
So what is the distance travelled by the cart in metres when the front wheel has done nine more revolutions than the rear wheel?</pre></label>
    
        <br>
        <div class="<?php if($row['attempt']=='Yes') {echo "attempted";}?>">
        <div class="radio ">
            <label><input type="radio" name="q1" value="1330">1330</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="572">572</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="399">399</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="3990">3990</label>
        </div>
        </div>
        <?php
        if($row['attempt']=='Yes')
