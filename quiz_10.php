    ...
    <div class="container">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <label for="q1"><pre>There are two types of sugar. One is priced at Rs 62 per kg and the other is priced at Rs 72 per kg.
If the two types are mixed together, the price of new mixture will be Rs 64.50 per kg. 
Find the ratio of the two types of sugar in this new mixture.</pre></label>
    
        <br>
        <div class="<?php if($row['attempt']=='Yes') {echo "attempted";}?>">
        <div class="radio ">
            <label><input type="radio" name="q1" value="2:5">2:5</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="3:1">3:1</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="6:7">6:7</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="6:7">3:2</label>
        </div>
        </div>
        <?php
        if($row['attempt']=='Yes')
