    ...
    <div class="container">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <label for="q1"><pre>A train is running at a speed of 100Kmph. 
A car is running on road parallel to the train’s track at a speed of 20 Kmph in the same direction as of train. 
How much time will it take to cross the car if the length of the train is 100 meters?</pre></label>
    
        <br>
        <div class="<?php if($row['attempt']=='Yes') {echo "attempted";}?>">
        <div class="radio ">
            <label><input type="radio" name="q1" value="5">5 Sec</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="4">4 Sec</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="5.5">5.5 Sec</label>
        </div>
        <div class="radio">
            <label><input type="radio" name="q1" value="4.5">4.5 Sec</label>
        </div>
        </div>
        <?php
        if($row['attempt']=='Yes')
